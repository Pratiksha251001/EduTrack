...
export const Departments: React.FC = () => {
  ...
  const handleClearDefaultData = () => {
    if (
      ...
      setNotice(
        "All default data removed. You can now create your departments, faculty, and students.",
      );
      ...
      <CrudPage<Department>
        ...
        fields={[
          ...
          { key: "code", label: "Department Code (e.g. CSE)", required: true },
          {
            ...
            type: "select",
            helperText:
              "Assign a faculty member as Head of Department. HODs can also teach subjects & mark lecture attendance.",
            options: [
        ...
        columns={[
          ...
          },
          {
            header: "HOD",
            render: (d) =>
              teachers.find((t) => t.id === d.hod_id)?.full_name ||
              "Unassigned",
          },
          {
            header: "Status",
